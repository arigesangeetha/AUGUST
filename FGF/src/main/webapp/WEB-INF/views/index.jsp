	...
	<nav class="bg-danger" >
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="index"><span class="glyphicon glyphicon-gift"></span> Fashion Trends(FGF)
				</a>
			</div>
				...
				<c:choose>
							...
							<c:when test="${!Administrator}">
								<li style="float: right"><a href="viewcart"
									class="w3-hover-none"><i
										class="glyphicon glyphicon-shopping-cart"></i>(${cartsize})</a></li>
							</c:when>
						</c:choose>
					...
					<c:otherwise>
						...
						<li class="active"><a href="Register"> <span
								class="glyphicon glyphicon-log-in"></span> SIGN UP
						</a></li>
	...
	<table class="table">
		...
		<tbody>
			...
			<td><i class="fa fa-envelope" style="font-size: 30px;"></i>
					...
					<a href="mailto:support@company.com">support@fashion.com</a><br>
					<i class="fa fa-phone" style="font-size: 30px; "></i>
				<a>+1 555 123456</a>
				<i class="fa fa-map-marker" style="font-size: 30px; color:"></i>
				<a>
					21 Revolution Street </a>
				</td>
				<td><div class="footer-icons">
				<a href="#"><i class="fa fa-facebook-official"style="font-size: 30px; "></i> 
				<a href="#"><i class="fa fa-twitter" style="font-size: 30px; "></i></a> 
				<a href="#"><i class="fa fa-linkedin-square" style="font-size: 30px; "></i></a> 
						<a href="#"><i class="fa fa-google" style="font-size: 30px; "></i></a>
						<a href="#"><i class="fa fa-google-plus-official" style="font-size: 30px;"></i></a>
						<a href="#"><i class="fa fa-whatsapp" style="font-size: 30px; "></i></a>
						
			</div></td>
			<td>
			<a href="#"><i class="fa fa-paypal" aria-hidden="true" style="font-size: 30px; "></i> </a> . <a
				href="#"><i class="fa fa-cc-amex" aria-hidden="true" style="font-size: 30px;"></i> </a> . <a
				href="#"><i class="fa fa-cc-mastercard" aria-hidden="true" style="font-size: 30px; "></i>
			...
			</a> . <a href="#"><i class="fa fa-google-wallet" aria-hidden="true" style="font-size: 30px; "></i>
			</a> . <a href="#"><i class="fa fa-cc-stripe" aria-hidden="true" style="font-size: 30px; "></i>
			</a></td>
